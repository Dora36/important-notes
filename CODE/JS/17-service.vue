                    ...
                    <div class="flex-center">
                      <transition name="calculate">
                        <div class="flex-center" v-show="itemPro.num">
                          <div class="calculate flex-center" @click="calculate('minus',index,indexPro)">-</div>
                          <div class="item-num flex-center">{{itemPro.num}}</div>
                        </div>
                      </transition>
                      <div class="calculate flex-center" @click="calculate('add',index,indexPro)">+</div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        contentFixed: false,
        proActive: 0,
        serverType: [{ image: require('_images_/occupy.jpg') }],
        serverActive: 0,
        proInfo: [],
        orderTotalPrice: 0,
        widthData: 0,
    ...
    methods: {
      ...
      handleScroll(e) {
        console.log(this.bodyScrollLock);
      ...
      // 动画滑动
      // smoothScroll(el, scrollTop, targetScroll, direction = 'none', fn = '') {
      //     if (direction === 'up') {
      ...
      //             setTimeout(() => {
      //                 this.smoothScroll(el, scrollTop, targetScroll, 'up', fn);
      //             }, 1);
      //         } else {
      //             if (el === 'body') {
      ...
      //             }
      //             setTimeout(() => {
      //                 this.smoothScroll(el, scrollTop, targetScroll, 'down', fn);
      //             }, 1);
      //         } else {
      //             if (el === 'body') {
      //                 document.body.scrollTop = targetScroll;
      ...
      toggleProType(idx) {
        ...
        document.documentElement.body.scrollTop += distance;
